...
function Frame:GetLevelToggle()
	return self.levelToggle
end

function Frame:CreateLevelToggle()
	local f = Bagnon.LevelToggle:New(self:GetFrameID(), self)
	self.levelToggle = f
	return f
end

function Frame:HasLevelToggle()
	return true
end
...
function Frame:GetTypeFilterToggle()
	return self.typeFilterToggle
end

function Frame:CreateTypeFilterToggle()
	local f = Bagnon.TypeFilterToggle:New(self:GetFrameID(), self)
	self.typeFilterToggle = f
	return f
end
